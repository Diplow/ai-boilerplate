  ...
  return (
    <div className="flex flex-col gap-3">
      <input type="text" placeholder="First name *" value={formData.firstName}
        onChange={handleChange("firstName")} required className={INPUT_CLASS_NAME} />
      <input type="text" placeholder="Last name *" value={formData.lastName}
        onChange={handleChange("lastName")} required className={INPUT_CLASS_NAME} />
      <input type="email" placeholder="Email" value={formData.email}
        onChange={handleChange("email")} className={INPUT_CLASS_NAME} />
      <input type="text" placeholder="Company" value={formData.company}
        onChange={handleChange("company")} className={INPUT_CLASS_NAME} />
      <input type="text" placeholder="Job title" value={formData.jobTitle}
        onChange={handleChange("jobTitle")} className={INPUT_CLASS_NAME} />
      <input type="tel" placeholder="Phone" value={formData.phone}
        onChange={handleChange("phone")} className={INPUT_CLASS_NAME} />
      <textarea placeholder="Notes" value={formData.notes}
        onChange={handleChange("notes")} rows={3} className={INPUT_CLASS_NAME} />
    </div>
  );
}
